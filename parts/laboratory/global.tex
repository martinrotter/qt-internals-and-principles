...
QtGlobal offers very fundamental functions for value-based comparing and other basic tasks. These functions (often) wrap similar functions from standard C/\cpp li-brary\index{standard library}. Most used functions are:
\begin{description}
